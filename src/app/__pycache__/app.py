...
with both programmatic REST API access and a user-friendly Gradio web interface.
...
# Ensure python path resolution for src module imports
...
def gradio_interface(
    ...
    """Gradio interface function processing form inputs and returning churn prediction."""
    data = {
        "gender": gender,
        "Partner": Partner,
